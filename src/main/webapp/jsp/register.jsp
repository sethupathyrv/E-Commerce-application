...
<body class="ap-locale-en_IN a-aui_51744-c a-aui_57326-c a-aui_72554-c a-aui_83815-c a-aui_86171-c a-aui_96511-c a-aui_accessibility_49860-c a-aui_attr_validations_1_51371-c a-aui_bolt_62845-c a-aui_noopener_84118-c a-aui_ux_102912-c a-aui_ux_59374-c a-aui_ux_60000-c a-aui_ux_92006-c a-aui_ux_98513-c a-dex_92889-c"> <img height="1" width="1" style='display:none;visibility:hidden;' src='http://fls-eu.amazon.com/1/batch/1/OP/A21TJRUUN4KGV:262-1154870-0296601:P69ZD323SGSG31TA4FXQ$uedata=s:%2Fap%2Fuedata%3Fstaticb%26id%3DP69ZD323SGSG31TA4FXQ:0' alt="" />
    ...
    <div class="a-section a-padding-medium auth-workflow">
        ...
        <div class="a-section auth-pagelet-container">
            ...
            <div class="a-section auth-pagelet-container">
                ...
                <form id="ap_register_form" name="register" method="post" action='register' class="ap_ango_default auth-validate-form-moa auth-real-time-validation">
...
<%--</select><span tabIndex="-1" id="auth-country-picker-container" class="a-button a-button-dropdown"><span class="a-button-inner"><span class="a-button-text a-declarative" data-action="a-dropdown-button" role="button" tabIndex="0" aria-hidden="true"><span class="a-dropdown-prompt">IN +91</span></span><i class="a-icon a-icon-dropdown"></i></span>--%>
                            ...
                            <div class="a-section a-spacing-base ap_email_fields">
                                <div class="a-row a-spacing-micro">
                                    ...
                                    <input type="email" maxlength="64" id="ap_email" name="email" tabindex="4" class="a-input-text a-span12 auth-require-email-validaton" data-validation-id="email">
                            ...
                            <div class="auth-require-fields-match-group">
                                ...
                                <div class="a-row a-spacing-base">
                                    ...
                                    <input type="password" maxlength="1024" id="ap_password" autocomplete="off" placeholder="At least 6 characters" name="psword" tabindex="5" class="a-input-text a-span12 auth-required-field auth-require-fields-match  auth-require-password-validation">
        ...
        <div class="a-section a-spacing-top-extra-large auth-footer">
            ...
            <div class="a-section a-spacing-small a-text-center a-size-mini">
                ...
                <a class="a-link-normal" target="_blank" rel="noopener noreferrer" href="https://www.amazon.in/gp/help/customer/display.html/ref=ap_desktop_footer_cou?ie=UTF8&amp;nodeId=200545940">
                    Conditions of Use
                </a>
                <span class="auth-footer-seperator"></span>
                ...
                <a class="a-link-normal" target="_blank" rel="noopener noreferrer" href="https://www.amazon.in/gp/help/customer/display.html/ref=ap_desktop_footer_privacy_notice?ie=UTF8&amp;nodeId=200534380">
                    Privacy Notice
                </a>
                <span class="auth-footer-seperator"></span>
...
<div id='be' style="display:none;visibility:hidden;">
    <form name='ue_backdetect' action="https://www.amazon.in/ap/get"><input type="hidden" name='ue_back' value='1' /></form>
...
<noscript>
    <img height="1" width="1" style='display:none;visibility:hidden;' src='http://fls-eu.amazon.com/1/batch/1/OP/A21TJRUUN4KGV:262-1154870-0296601:P69ZD323SGSG31TA4FXQ$uedata=s:%2Fap%2Fuedata%3Fnoscript%26id%3DP69ZD323SGSG31TA4FXQ:0' alt=""/>
</noscript>
</body>
