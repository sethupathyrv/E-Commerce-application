...
@WebServlet(name = "AmazonPayController")
public class AmazonPayController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(user==null){
            ...
            RequestDispatcher rd = request.getRequestDispatcher("/jsp/amazonPay.jsp");
            rd.forward(request,response);
        }
